<template>
  <form class="arts-directory__view-search" v-on:submit.prevent="handleSubmit($event)">
    <div class="form-item">
      <label for="presenting-rosters-view-search-input">Search by Name</label>
      <input
        class="arts-directory__search-input text-input"
        type="text"
        id="presenting-rosters-view-search-input"
        v-model="viewState.keywordSearchValue"
        ref="input"
      />
    </div>
    <div class="form-item">
      <label for="presenting-rosters-view-county-select">Located In</label>
      <select
        class="select"
        id="presenting-rosters-view-county-select"
...
import { state as viewState, actions as ViewActionsAlpha } from "./presenting-rosters-view-store";
