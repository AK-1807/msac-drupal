  ...
  <div class="arts-directory__results">
    ...
    >
      <li class="arts-directory__feed-list-item" v-for="result in results" :key="result.id">
        <teaching-rosters-view-feed-item :data="result" />
      </li>
    </arts-directory-feed>
  </div>
</template>
...
import TeachingRostersViewFeedItem from "./teaching-rosters-view-feed-item.vue";
import { state as viewState, actions as viewActions, getters as viewGetters } from "./teaching-rosters-view-store";
...
export default {
  ...
  components: {
    ...
    "teaching-rosters-view-feed-item": TeachingRostersViewFeedItem,
  },
  computed: {
    canFetchMore() {
