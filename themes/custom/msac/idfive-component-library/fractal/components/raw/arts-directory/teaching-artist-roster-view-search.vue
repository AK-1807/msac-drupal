<template>
  <form class="arts-directory__view-search" v-on:submit.prevent="handleSubmit($event)">
    <div class="form-item">
      <label for="teaching-artist-roster-view-search-input">Search by Keyword</label>
      <input
        class="arts-directory__search-input text-input"
        type="text"
        id="teaching-artist-roster-view-search-input"
        v-model="viewState.keywordSearchValue"
        ref="input"
      />
    </div>
    <div class="form-item">
      <label for="teaching-artist-roster-view-county-select">Located In</label>
      <select
        class="select"
        id="teaching-artist-roster-view-county-select"
...
import { state as viewState, actions as viewActions } from "./teaching-artist-roster-view-store";
