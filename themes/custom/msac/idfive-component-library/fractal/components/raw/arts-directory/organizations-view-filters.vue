<template>
  <div class="arts-directory__view-filters">
    ...
    <div class="arts-directory__filters-modal modal" id="organizations-filters-modal" aria-hidden="true">
      <div class="modal__overlay" tabindex="-1" data-micromodal-close>
        <div
          class="modal__container"
          role="dialog"
          aria-modal="true"
          aria-labelledby="organizations-filters-modal-title"
        >
          <div class="modal__header">
            ...
            <h2 class="modal__title" id="organizations-filters-modal-title">
              Filter Organizations and Businesses
            </h2>
          </div>
          <div class="modal__content" id="organizations-filters-modal-content">
            <form @submit="handleFilterSubmit($event)">
              ...
              <div class="form-item" v-if="bookingPricesFetched">
                <label for="organizations-booking-price-filter">Booking Price</label>
                <select
                  class="select"
                  id="organizations-booking-price-filter"
                  v-model="filters.bookingPrice.dirtyValue"
                >
              ...
              <div class="form-item" v-if="aeDistrictsFetched">
                <label for="organizations-ae-district-filter">A&amp;E District</label>
                <select class="select" id="organizations-ae-district-filter" v-model="filters.aeDistrict.dirtyValue">
              ...
              <div class="form-item form-item-checkbox">
                <input
                  type="checkbox"
                  id="organizations-presenting-touring-filter"
                  class="form-checkbox"
                  v-model="filters.presentingTouring.dirtyValue"
                />
                <label for="organizations-presenting-touring-filter">Maryland Touring Grant Funding Available</label>
              </div>
              <div v-if="artsInEducationFetched">
                ...
                <div class="form-item form-item-checkbox">
                  ...
                  <label for="select-all-aei-filters">
                    View All Organizations With Arts In Education Funding
                  </label>
                </div>
                <div :hidden="viewState.selectAllArtsInEducationFilters">
                  ...
                  <fieldset>
                    ...
                    <div class="form-item form-item-checkbox">
                      <input
                        type="checkbox"
                        id="organizations-lectures-filter"
                        class="form-checkbox"
                        v-model="filters.lectures.dirtyValue"
                      />
                      <label for="organizations-lectures-filter">Lectures</label>
                    </div>
                    <div class="form-item form-item-checkbox">
                      <input
                        type="checkbox"
                        id="organizations-online-programs-filter"
                        class="form-checkbox"
                        v-model="filters.onlinePrograms.dirtyValue"
                      />
                      <label for="organizations-online-programs-filter">Online Programs</label>
                    </div>
                    <div class="form-item form-item-checkbox">
                      <input
                        type="checkbox"
                        id="organizations-out-of-school-time-filter"
                        class="form-checkbox"
                        v-model="filters.outOfSchoolTime.dirtyValue"
                      />
                      <label for="organizations-out-of-school-time-filter">Out of School Time</label>
                    </div>
                    <div class="form-item form-item-checkbox">
                      <input
                        type="checkbox"
                        id="organizations-residency-filter"
                        class="form-checkbox"
                        v-model="filters.residency.dirtyValue"
                      />
                      <label for="organizations-residency-filter">Residency</label>
                    </div>
                    <div class="form-item form-item-checkbox">
                      <input
                        type="checkbox"
                        id="organizations-visiting-performance-filter"
                        class="form-checkbox"
                        v-model="filters.visitingPerformance.dirtyValue"
                      />
                      <label for="organizations-visiting-performance-filter">Visiting Performance</label>
                    </div>
                    <div class="form-item form-item-checkbox">
                      <input
                        type="checkbox"
                        id="organizations-workshop-filter"
                        class="form-checkbox"
                        v-model="filters.workshop.dirtyValue"
                      />
                      <label for="organizations-workshop-filter">Workshop</label>
                    </div>
                    <div class="form-item form-item-checkbox">
                      <input
                        type="checkbox"
                        id="organizations-professional-development-filter"
                        class="form-checkbox"
                        v-model="filters.professionalDevelopment.dirtyValue"
                      />
                      <label for="organizations-professional-development-filter">Professional Development</label>
                    </div>
                    <div class="form-item form-item-checkbox">
                      <input
                        type="checkbox"
                        id="organizations-field-trip-filter"
                        class="form-checkbox"
                        v-model="filters.fieldTrip.dirtyValue"
                      />
                      <label for="organizations-field-trip-filter">Field Trip</label>
                    </div>
                  </fieldset>
                </div>
              </div>
...
import { state as viewState, getters as viewGetters, actions as viewActions } from "./organizations-view-store";
...
export default {
  ...
  methods: {
    ...
    showFiltersModal() {
      this.$modal.show("organizations-filters-modal");
    },
    ...
    handleFilterSubmit(event) {
      ...
      this.$modal.close("organizations-filters-modal");
    },
