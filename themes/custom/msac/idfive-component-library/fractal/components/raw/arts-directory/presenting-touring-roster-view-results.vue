  ...
  <div class="arts-directory__results">
    ...
    >
      <li class="arts-directory__feed-list-item" v-for="result in results" :key="result.id">
        <presenting-touring-roster-view-feed-item :data="result" />
      </li>
    </arts-directory-feed>
  </div>
</template>
...
import PresentingTouringRosterViewFeedItem from "./presenting-touring-roster-view-feed-item.vue";
import {
  state as viewState,
  actions as viewActions,
  getters as viewGetters,
} from "./presenting-touring-roster-view-store";
...
export default {
  ...
  components: {
    ...
    "presenting-touring-roster-view-feed-item": PresentingTouringRosterViewFeedItem,
  },
  computed: {
    canFetchMore() {
