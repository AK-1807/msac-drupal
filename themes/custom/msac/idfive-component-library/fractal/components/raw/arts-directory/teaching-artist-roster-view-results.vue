  ...
  <div class="arts-directory__results">
    ...
    >
      <li class="arts-directory__feed-list-item" v-for="result in results" :key="result.id">
        <teaching-artist-roster-view-feed-item :data="result" />
      </li>
    </arts-directory-feed>
  </div>
</template>
...
import TeachingArtistRosterViewFeedItem from "./teaching-artist-roster-view-feed-item.vue";
import {
  state as viewState,
  actions as viewActions,
  getters as viewGetters,
} from "./teaching-artist-roster-view-store";
...
export default {
  ...
  components: {
    ...
    "teaching-artist-roster-view-feed-item": TeachingArtistRosterViewFeedItem,
  },
  computed: {
    canFetchMore() {
